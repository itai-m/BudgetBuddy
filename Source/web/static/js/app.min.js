...
$.BudgetBuddy = {}, $.BudgetBuddy.options = {
        ...
        "undefined" != typeof BudgetBuddyOptions && $.extend(!0, $.BudgetBuddy.options, BudgetBuddyOptions);
        ...
        }).css("width", "100%"), a.sidebarPushMenu && $.BudgetBuddy.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.BudgetBuddy.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(a.directChat.contactToggleSelector).on("click", function() {
