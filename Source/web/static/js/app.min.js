...
function _init() {
    $.BudgetBuddy.layout = {
        ...
        fix: function() {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                var e = $($.BudgetBuddy.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        },
        fixSidebar: function() {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && console && console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.BudgetBuddy.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
    ...
    }, $.BudgetBuddy.pushMenu = {
        activate: function(a) {
            var b = $.BudgetBuddy.options.screenSizes;
            ...
            }), ($.BudgetBuddy.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function() {
            var a = this,
                b = $.BudgetBuddy.options.screenSizes.sm - 1;
    ...
    }, $.BudgetBuddy.controlSidebar = {
        activate: function() {
            var a = this,
                b = $.BudgetBuddy.options.controlSidebarOptions,
                c = $(b.selector),
        ...
        open: function(a, b) {
            var c = this;
            b ? (a.addClass("control-sidebar-open"), $(".content-wrapper, .right-side").on("click", function() {
                c.close(a, b)
    ...
    }, $.BudgetBuddy.boxWidget = {
        selectors: $.BudgetBuddy.options.boxWidgetOptions.boxWidgetSelectors,
        icons: $.BudgetBuddy.options.boxWidgetOptions.boxWidgetIcons,
        activate: function() {
            var a = this;
...
if ("undefined" == typeof jQuery) throw new Error("BudgetBuddy requires jQuery");
$.BudgetBuddy = {}, $.BudgetBuddy.options = {
        ...
        "undefined" != typeof BudgetBuddyOptions && ($.BudgetBuddy.options = $.extend({}, $.BudgetBuddy.options, BudgetBuddyOptions));
        var a = $.BudgetBuddy.options;
        _init(), $.BudgetBuddy.layout.activate(), $.BudgetBuddy.tree(".sidebar"), a.enableControlSidebar && $.BudgetBuddy.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
